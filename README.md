...
[![Build Status](https://travis-ci.com/UMM-CSci-3601/production-template-s19.svg?branch=master)](https://travis-ci.com/UMM-CSci-3601/production-template-s19)

This is your starter code for Iteration 1.

We've left a number of bits and pieces in here to give you some starter materials, but you should _definitely_ clean out things you don't need, including Markdown files, JSON data files, and the like.
